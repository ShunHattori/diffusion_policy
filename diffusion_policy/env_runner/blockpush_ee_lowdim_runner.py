...
from diffusion_policy.env.block_pushing_ee.block_pushing_multimodal import (
    BlockPushMultimodal,
)
...
class BlockPushEELowdimRunner(BaseLowdimRunner):
    def __init__(
        self,
        output_dir,
        n_train=10,
    ...
    def run(self, policy: BaseLowdimPolicy):
        ...
        for chunk_idx in range(n_chunks):
            ...
            pbar = tqdm.tqdm(
                ...
                desc=f"Eval BlockPushEELowdimRunner {chunk_idx+1}/{n_chunks}",
                leave=False,
