...
from diffusion_policy.env.block_pushing_mod.utils import utils_pybullet
from diffusion_policy.env.block_pushing_mod.utils.pose3d import Pose3d

XARM_URDF_PATH = "third_party/py/envs/assets/urdf/" "ur5.urdf"  # ur5に変更
...
class XArmSimRobot:
    ...
    def set_target_effector_pose(self, world_effector_pose):
        ...
        # debug print for handcoding initial jotint positions
