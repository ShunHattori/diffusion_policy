...
def animate_episode(zarr_path: str, video_name: str, epi_slice: slice):
    ...
    cmap_block1 = get_cmap("Blues")
    cmap_block2 = get_cmap("Greens")
    cmap_ee = get_cmap("Reds")
...
animate_episode(
    zarr_path="data/block_pushing_mod/block_pushing_mod2.zarr", video_name="episode_mod.mp4", epi_slice=slice(100, 120)
)
animate_episode(
    zarr_path="data/block_pushing/multimodal_push_seed.zarr", video_name="episode_seed.mp4", epi_slice=slice(100, 120)
)
